...
async function execute(message) {
        ...
        try {
            ...
            console.log(`top10 result----------------`, topResults);
        ...
        //     });
            ...
            //     await interaction.deferReply();
                const coinId = topResults[0].id; // Replace with the actual coin ID from the button interaction
                try {
                        ...
                        .addFields(
                            {
                                ...
                                value: [
                                    ...
                                    `**💧 24h Volume:** $${formatCompactNumber(volume)}`,
                                ].join('\n'),
                                inline: true
                            },
                            {
                                ...
                                value: [
                                    ...
                                    `**🔄 Circulating Supply:** ${formatCompactNumber(marketData.circulating_supply || 0)} ${tokenData.symbol.toUpperCase()}`,
                                    `**💰 Fully Diluted Valuation:** $${formatCompactNumber(marketData.fully_diluted_valuation?.usd || 0)}`,
                                ].join('\n'),
                                inline: true
                            }
                        )
